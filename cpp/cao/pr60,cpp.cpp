...
//delet overloaded for loc arrays.
void loc::operator delete[] (void *p)
{
...
int main()
{
	...
	} catch (bad_alloc xa) {cout << "Allocation error for p1.\n";
	return 1;;
	}
	
	try{
		p2 = new loc(-10,-20);
	} catch (bad_alloc xa) {cout << "Allocation error for p2.\n";
	return 1;;
	}
